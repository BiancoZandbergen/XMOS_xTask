...
int main(void)
{
  ...
  par {
    ...
    on tile[AP_TILE_0] : xtask_comserver(c0_not, c0_man, 2, ring[0], ring[1], 1);
    ...
    on tile[AP_TILE_0] : start_kernel_1(c0_man[1], c0_not[1]);
    on tile[AP_TILE_1] : start_kernel_2(c1_man[0], c1_not[0]);
  }
